        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <form method="POST" action="{{ route('subjects.store') }}">
                ...
                <div>
                    ...
                    <x-select-input id="grade" name="grade" :options="[7,8,9,10,11,12]" required/>
                ...
                <div>
                    ...
                    <x-text-input id="img" class="block mt-1 w-full" type="text" name="img" :value="old('img')" autocomplete="img" />
                ...
                <div>
                    ...
                    <x-select-multiple name="teachers[]" id="teachers">
                        @foreach ($users as $user)
                            <option class="py-0.5" value="{{ $user->id }}">{{ $user->name }} {{ $user->middlename }} {{ $user->surname }}</option>
                        @endforeach
                    </x-select-multiple>
                </div>
