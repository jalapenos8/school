    ...
    <div class="flex max-w-7xl pb-2 mx-auto mt-2 px-4 sm:px-6 lg:px-8 text-lg text-gray-800 dark:text-gray-200 leading-tight">
        ...
        <x-lesson-content class="text-xl leading-9">
            <div class="flex flex-col min-h-full">
                <div class="flex items-center w-full grow-0 shrink basis-auto pt-6">
                ...
                <div class="flex grow-1 shrink basis-auto">
                    <div class="w-full">
                        @if($step->type == 'theory')
                ...
                <div class="flex items-center justify-between grow-0 shrink mt-auto pb-6">
